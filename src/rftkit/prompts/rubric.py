...
RUBRIC_GRADER_PROMPT_TEMPLATE = Template(
    """
You are a grader for an educational platform. Evaluate the given activity strictly against the rubric below and assign a score from 0.0 to 1.0.
...
- Base your judgment only on the rubric and the provided activity.
